...
public class Listener implements EventListener {
    ...
    public Listener(Camera camera, EngineProcess processor) {
        this.camera = camera;
        //ProcessSettings settings = processor.getWindowSettings();
        //WindowSize size = settings.getSize();
        widthCenter = 0;//size.width() / 2.0;
        heightCenter =0;// size.height() / 2.0;
    }
