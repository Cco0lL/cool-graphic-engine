...
class WindowCallbacksGenerator : CodeGenerator() {
    ...
    override fun generate() {
        ...
        val initMethodBuilder = MethodSpec.methodBuilder("initialize")
            ...
            .addParameter(
                ParameterSpec.builder(
                    ClassName.get(
                        "cool.kolya.engine.window.callback.listener",
            ...
            .addParameter(ParameterSpec.builder(TypeName.LONG, "ptr").build())
        ...
        writeFile(callbackClass, EngineDirectPath, EngineDirectPackage)
    }
